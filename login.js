...
var appkey = 'FFFF0N000000000097AD';
var nc = null;
var nc_token = '';
var csessionid = '';
var sig = '';
...
jQuery.extend({
    ...
    popup_show_login_error: function(msg) {
        ...
        if (msg && msg.indexOf('重新设置密码') > -1) {
            msg = msg.substring(0, msg.indexOf('重新设置密码')) + '<a href="' + popup_baseUrl + popup_publicName + '/forgetPassword/initforgetMyPassword" style="color:#3B99FC">' + '重新设置密码' + '</a>' + msg.substring(msg.indexOf('重新设置密码') + 6);
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.result_code == 0) {
                    ...
                    var updatePwdMsg = '您的密码很久没有修改了，为降低安全风险，请您' + '<a href="' + popup_baseUrl + popup_publicName + '/forgetPassword/initforgetMyPassword" style="color:#3B99FC">' + '重新设置密码' + '</a>' + '后再登录。';
